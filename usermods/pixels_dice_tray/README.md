...
First, the BLE stack requires a lot of flash. I had to make a special partitioning plan `tools/WLED_ESP32_4MB_64KB_FS.csv` to even fit the build on 4MB devices. This only has 64KB of file system space, which is limited, but still functional.
