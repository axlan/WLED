...
const char PAGE_usermod[] PROGMEM = R"=====(<!DOCTYPE html><html><head><meta name="viewport" 
content="initial-scale=1,user-scalable=no"><meta charset="utf-8"><title>
Globe Interface</title><style>
#map{height:100%}body,html{height:100%;margin:0;padding:0}</style></head><body>
<div id="map"></div><script defer="defer" 
src="https://code.jquery.com/jquery-3.5.1.min.js"></script><script 
defer="defer" src="http://SCRIPT_HOST/map_ctrl.js"></script></body></html>)=====";
